...
export function getTetrisMelody(tempo = 120) {
...
export function generateSineWave(frequency, durationMs, sampleRate = 44100, volume = 0.3) {
    const samples = [];
...
export function applyEnvelope(samples, durationMs, sampleRate = 44100) {
...
export function floatToPCM(floats) {
...
export function createWavHeader(audioLength, sampleRate = 44100, numChannels = 1, bitsPerSample = 16) {
...
export function generateTetrisMusicWav(tempo = 120, sampleRate = 44100) {
...
export function generateBeep(frequency = 800, durationMs = 100, sampleRate = 44100) {
